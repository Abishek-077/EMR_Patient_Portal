...
function App() {
  ...
  const portalPaths = ['/home', '/dashboard', '/registration', '/records', '/appointments', '/messages', '/prescriptions', '/billing', '/resources', '/family', '/referrals', '/immunizations', '/trends', '/profile', '/admin/access-control'];
