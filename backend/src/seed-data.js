...
export const seedData = {
  ...
  appointmentSlots: [
    { id: 'slot-cardio-jenkins-1', providerId: 'provider-sarah-jenkins', department: 'Cardiology', date: isoDateFromNow(3), time: '09:15 AM', status: 'Available' },
    { id: 'slot-cardio-jenkins-2', providerId: 'provider-sarah-jenkins', department: 'Cardiology', date: isoDateFromNow(4), time: '10:30 AM', status: 'Available' },
    { id: 'slot-cardio-chen-1', providerId: 'provider-michael-chen', department: 'Cardiology', date: isoDateFromNow(3), time: '11:45 AM', status: 'Available' },
    { id: 'slot-primary-wilson-1', providerId: 'provider-james-wilson', department: 'Primary Care', date: isoDateFromNow(5), time: '08:00 AM', status: 'Available' },
    { id: 'slot-primary-emily-1', providerId: 'provider-emily-chen', department: 'Primary Care', date: isoDateFromNow(6), time: '02:15 PM', status: 'Available' },
  ],
  tasks: [
    {
      id: 'task-1',
  ...
  refillRequests: [
    {
      id: 'refill-demo-queued',
      prescriptionId: 'rx-atorvastatin',
      prescriptionName: 'Atorvastatin 20 mg Tablet',
      pharmacyName: 'CVS Pharmacy #04322',
      status: 'Queued',
    ...
    paymentMethods: [
      {
        ...
        isDefault: true,
        tokenReference: 'local-demo-card-4242',
      },
      {
        id: 'method-bank',
        type: 'Bank',
        ...
        tokenReference: 'local-demo-bank-1902',
      },
    ],
    invoices: [
      {
  ...
  labResults: [
    { label: 'Glucose, Fasting', value: 94, unit: 'mg/dL', range: '65 - 99 mg/dL', observedAt: isoDateFromNow(-2), tone: 'good' },
    { label: 'Cholesterol, Total', value: 210, unit: 'mg/dL', range: '< 200 mg/dL', observedAt: isoDateFromNow(-2), tone: 'warning' },
    { label: 'Hemoglobin A1c', value: 5.4, unit: '%', range: '4.8 - 5.6 %', observedAt: isoDateFromNow(-2), tone: 'good' },
    { label: 'Vitamin D, 25-OH', value: 28, unit: 'ng/mL', range: '30 - 100 ng/mL', observedAt: isoDateFromNow(-2), tone: 'warning' },
  ],
  clinicalNotes: [
    {
      id: 'note-post-op',
  ...
  immunizationRecords: {
    ...
    compliance: {
      ...
      completed: 11,
      recommended: 13,
      detail: '11 of 13 recommended immunization records are documented.',
    },
  },
